...
def validate_no_circular_dependency(task_id: int, depends_on_id: int, existing_deps: List) -> Tuple[bool, str]:
    """
    ...
    # Check if adding task_id -> depends_on_id creates a cycle
    # This happens if depends_on_id has a path back to task_id
    visited = set()
    ...
    # Check if depends_on_id can reach task_id
