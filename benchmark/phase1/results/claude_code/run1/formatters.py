...
def format_dashboard(data: Dict[str, Any]) -> str:
    """Format the dashboard analytics data as a readable report."""
    lines = [
        ...
        f"Avg completion time: {data['avg_completion_time']:.1f} hours",
        "",
    ]
