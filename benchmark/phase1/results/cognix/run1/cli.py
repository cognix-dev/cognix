...
def build_parser() -> argparse.ArgumentParser:
    ...
    # recurring-add
    p = sub.add_parser("recurring-add", help="Add recurring rule")
    p.add_argument("task_id", type=int)
    p.add_argument("frequency", choices=["daily", "weekly", "biweekly", "monthly"])
    p.add_argument("--end-date", default=None)

    # recurring-list
    sub.add_parser("recurring-list", help="List recurring rules")
    ...
    # recurring-cancel
    p = sub.add_parser("recurring-cancel", help="Cancel recurring rule")
...
def main():
    ...
    if args.command == "init":
        ...
        cmd_run_recurring(args.user_id)
