...
def validate_no_circular_dependency(task_id: int, depends_on_id: int,
                                   existing_deps: List) -> Tuple[bool, str]:
    """
    ...
    # DFS to detect cycle starting from depends_on_id
    # If we can reach task_id from depends_on_id, there's a cycle
    visited = set()
    rec_stack = set()
    ...
    if has_cycle(depends_on_id):
        return False, "Circular dependency detected: adding this would create a cycle"
